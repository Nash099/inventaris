...
?>
        ...
        <div class="main-panel">
          ...
          <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Form Maintenance Mesin Dan Kendaraan</h4>
                    ...
                    <form enctype="multipart/form-data" autocomplete="off" action="action/action-add-history-kendaraan.php"  method="post" class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <input name="nama_brg" id="nama_brg" type="text" class="form-control" value="<?php echo $data['nama_brg']?>" placeholder="EX:SUPRA 125, GRANDMAX">
                      </div>
                      <div class="form-group">
                        <label for="pengguna">Pengguna</label>
                        <input name="pengguna" id="pengguna" type="text" class="form-control" value="<?php echo $data['pengguna']?>" placeholder="EX:SUPRA 125, GRANDMAX">
                      </div>
                      <div class="form-group">
